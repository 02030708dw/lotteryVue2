...
export default {
    ...
    methods: {
        ...
        drawClearBtn() {
            ...
            this.clearBtn = new Button({ id: 'btnLang', key: 'cleard', x: 1143, y: 386, p }, {
        ...
        drawFastBtn() {
            const p = this.container
            this.fastBtn = new Button({ id: 'btnLang', key: 'f', x: 1144, y: 250, p })
        },
        // 撤
        drawRemoveBtn() {
            const p = this.container
            this.removeBtn = new Button({ id: 'btnLang', key: 'remove', x: 5, y: 578, p }, {
                up: {
                    fn: () => {
                        if (this.isEraser) {
                            // 取消橡皮擦模式 的時候放音效
        ...
        drawOrderBtn() {
            const p = this.container
            this.orderBtn = new Button({ id: 'btnLang', key: 'orderd', x: 1097, y: 527, p }, {
        ...
        drawDobuleBtn() {
            const p = this.container
            this.dobuleBtn = new Button({ id: 'btnLang', key: 'doubled', x: 969, y: 577, p }, {
