...
export default {
    ...
    beforeMount() {
        this.timer = setInterval(() => this[_M.GET_FLIP_TIMEER_MY](this), this.flipTimer.updateTime)
    },
    destroyed() {
    ...
    computed: {
        ...
        hours() {
            return +this.$route.params.lottery === 289
                ? [this.number[1], this.number[1], this.number[1]]
                : [this.number[1]]
        },
        flipTimer() {
            return this.MY_flipTimer || {}
        },
        getDigit() {
