...
<script type="text/babel">
  ...
  export default {
    ...
    computed: {
      ...
      leftLabel() {
        return this.date.getFullYear() + ' ' + this.t(`el.datepicker.month${ this.date.getMonth() + 1 }`);
        // return this.date.getFullYear() + ' ' + this.t('el.datepicker.year') + ' ' + this.t(`el.datepicker.month${ this.date.getMonth() + 1 }`);
      },

      rightLabel() {
        return this.rightDate.getFullYear() + ' ' + this.t(`el.datepicker.month${ this.rightDate.getMonth() + 1 }`);
