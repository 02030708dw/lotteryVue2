...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            lotteryNameKey() {
                return (this.lotteryList2[this.MY_lotteryId] || {}).title_key || ''
            },
            isConfirmButton() {
                const money = this.fast ? this.MY_gameSelectDataMoney : this.MY_gameOrderMoney
            ...
            ltProject() {
                return this.fast ? this.MY_gameSelectDataArr : this.MY_gameOrderArr
            },
            ltMoneyAmout() {
                return formatNumber(this.fast ? this.MY_gameSelectDataMoney : this.MY_gameOrderMoney)
            },
            ltProjectNum() {
                return this.ltProject.length
            },
            ltIssueStart() {
                return this.MY_jsDynamicConfig.number
            },
            isShowCancelBtn() {
