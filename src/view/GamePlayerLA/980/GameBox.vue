    ...
    <div class="gr_container  bg_accent  u_clearfix">
        ...
        <div class="content bg_secondary_light">
            <div class="content_inner">
                <div class="list u_clearfix" v-for='(item, index) in LA_gameOrderArr'>
                    <div>
...
import BoxMixin from '@V/GamePlayerLA/components/BoxMixin'
export default {
    name: 'GameBox',
    mixins: [BoxMixin],
    data() {
