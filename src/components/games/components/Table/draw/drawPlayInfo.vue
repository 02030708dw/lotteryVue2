...
export default {
    ...
    beforeMount() {
        ...
        this.resourceArr.push(
            { id: 'playInfo', file: 'sp.json', urlPath: `${CDN}/static/pixi/share/playInfo/` }
        )
    },
    methods: {
        ...mapActions([
            _M.GET_PLAYINFO_NEW_LIST
        ]),
        drawPlayInfo() {
            ...
            this.drawPlayInfoTitle(bg)
            this.drawPlayInfocontent(bg)
