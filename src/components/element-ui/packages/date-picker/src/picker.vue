<template>
  <el-input
    ...
    <i slot="icon"
      ...
      :class="[ RWDMode === 3 & clearable ? (displayValue ? 'el-icon-circle-close' : triggerClass) : (showClose ? 'el-icon-circle-close' : triggerClass)]"
...
import Popper from '@E/src/utils/vue-popper';
...
export default {
  ...
  methods: {
    ...
    handleFocus() {
      ...
      this.isMobile && document.activeElement.blur()
      this.$emit('focus', this);
      if(!this.isMobileTouch()){document.body.scrollTop = 0}  
    },
