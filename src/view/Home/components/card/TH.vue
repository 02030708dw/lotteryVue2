<template>
    <div @click="menuClick(menu)">
        ...
        <img
            ...
            :src="`static/image/lang_${lang}/c_lottery-category/c_lottery-class--${menu.class2}/c_lottery--${lotteryId}.svg`"
        />
...
<script>
// static/image/lang_cn/c_lottery-category/c_lottery-class--TH/c_lottery--243.svg
// /static/img/static/image/lang_cn/c_lottery-category/c_lottery-class--TH_30S/c_lottery--243.svg
// url(/static/img/static/image/lang_cn/c_lottery-category/c_lottery-class--TH/c_lottery--242.svg)
import Mixin from './Mixin'
import Issue from '../issue/TH'
export default {
    name: 'TH',
    extends: Mixin,
    components: {
