          ...
          <div class="el-date-picker__time-header" v-if="showTime">
            <span class="el-date-picker__editor-wrap">
              <el-input
                ...
                :value="visibleDate"
                @focus="handleMobileNoShowKeybord"
                size="small"
  ...
  export default {
    ...
    watch: {
      ...
      timePickerVisible(val) {
        if (val) {
          this.$refs.timepicker.handleChange(new Date(this.date))
    ...
    methods: {
      ...
      handleTimePickerVisible() {
        this.timePickerVisible = !this.timePickerVisible
        this.handleMobileNoShowKeybord()
      },
      handleMobileNoShowKeybord() {
