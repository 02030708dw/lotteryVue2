<template>
    <div class="gr_lottery-favorite320" :class="{is_favorite: isInFavorites, is_tooltip: isTip}" @click.stop.prevent="setMyFavorites">
        <svg width="25" viewBox="0 0 17.85 16.11">
            <defs>
                <linearGradient id="favoritesRed2"
                    x1="0%" y1="0%"
                    x2="100%" y2="100%"
                    spreadMethod="pad">
                <stop offset="0%"   stop-color="#DF2741" stop-opacity="1"/>
                <stop offset="100%" stop-color="#8A012D" stop-opacity="0.78"/>
                </linearGradient>
            </defs>
            ...
            <path d="M8.93,3.15C8.17-.47,2.14-.66.77,3.65c-2.18,6.79,6.67,9,8.16,12,1.48-3.07,10.32-5.25,8.15-12C15.71-.66,9.68-.47,8.93,3.15Z"></path> <g stroke="none" stroke-width="1" mask="url(#gr_icon__mask)"></g> <path d="M8.93,3.15C8.17-.47,2.14-.66.77,3.65c-2.18,6.79,6.67,9,8.16,12,1.48-3.07,10.32-5.25,8.15-12C15.71-.66,9.68-.47,8.93,3.15Z" class="gr_my-favorites__shape"></path></svg>
