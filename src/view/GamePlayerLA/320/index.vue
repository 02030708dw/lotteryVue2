<template>
    <div>
        ...
        <div ref="container">
            ...
            <LA
                class="gr_game-th"
                :currentGame="`LA_${LA_menuIndex + 1}D`"
...
export default {
    ...
    beforeMount() {
        this.timer = setInterval(() => this[_M.GET_FLIP_TIMEER_LA](this), this.flipTimer.updateTime)
    ...
    methods: {
        ...
        scrollDown() {
            ...
            if (scrollTop >= 100 && this.$route.name === 'GamePlayerLA') {
