    ...
    <div v-if="isShowBox" class="el-message-box__wrapper" :style="{ zIndex }">
        <div class="el-message-box  el-scroll-content-message-box">
            <div class="el-message-box__header">
                ...
                <div @click="close" v-if="isShowCloseIcon"
                    style="position: absolute; top: 0; right: 0; height: 100%; width: 50px; background: transparent; cursor: pointer;" />
            </div>
            <div class="el-message-box__content">
                <component :is="currentBoxName[mode]" :lotteryName="lotteryName" :lastnumber="lastnumber"
                    :lotteryId="lotteryId" :historyBall="historyBall" :isSin="isSin" :subGame="subGame"
                    :gameMenu="gameMenu" :menuIndex="menuIndex" />
            </div>
        </div>
    </div>
</template>
