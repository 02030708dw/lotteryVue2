...
export default {
    ...
    computed: {
        ...
        getLotterySName() {
            const lotterySKey = {
                'lottery_name_202': 'lottery_name_s_002', //加拿大30秒龙虎斗> 加拿大30秒
                'lottery_name_203': 'lottery_name_s_003', //河内分分龙虎斗  > 河内分分
                'lottery_name_204': 'lottery_name_s_022', //台湾5分龙虎斗   > 5分龙虎斗
                'lottery_name_198': 'lottery_name_s_005', //重庆龙虎斗      > 重庆
                'lottery_name_199': 'lottery_name_s_006', //天津龙虎斗      > 天津
                'lottery_name_201': 'lottery_name_s_007', //腾讯龙虎斗      > 腾讯
                'lottery_name_200': 'lottery_name_s_008', //新疆龙虎斗      > 新疆
                ...
                'lottery_name_220': 'lottery_name_s_001', //HL1分彩龙虎斗   > HL 1分
                'lottery_name_221': 'lottery_name_s_019', //HL1.5分彩龙虎斗 > HL 1.5分
                'lottery_name_262': 'lottery_name_260', //澳洲幸运5龙虎斗 > 澳洲幸运5
                'lottery_name_270': 'lottery_name_114', // 幸运飞艇I
                'lottery_name_271': 'lottery_name_111', // 世彩30秒PK10
